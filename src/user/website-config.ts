...
let websiteConfig: WebsiteConfig = {
    ...
    menuItems: [
        { id: "D0C0E4A1-B74F-4BE6-99EC-10B247130CAE", name: "用户管理", path: "#user-list", icon: "icon-group", sortNumber: 300 },
        {
            id: "F24F018C-01E8-47A9-B6F8-BE811FBD2ED9", name: "个人中心", icon: "icon-user", sortNumber: 400,
            children: [
