 ...
 * 后台管理接口
 */
let RoleController = class RoleController extends maishu_node_mvc_1.Controller {
    list(dc) {
        return __awaiter(this, void 0, void 0, function* () {
            let roles = yield dc.roles.createQueryBuilder("role").orderBy("role.createDateTime", "DESC").getMany();
            return roles;
        });
    }
    add(dc, { role }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!role)
                throw errors_1.errors.fieldNull("role", "formData");
            yield dc.roles.insert(role);
        });
    }
    delete(dc, { roleId }) {
        return __awaiter(this, void 0, void 0, function* () {
...
RoleController = __decorate([
    maishu_node_mvc_1.controller("admin/role")
], RoleController);
