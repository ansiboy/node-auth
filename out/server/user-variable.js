...
exports.tokenConttent = tokenConttent;
/** 获取与用户相关的变量 */
function userVariable(key) {
    let userIdDecorator = maishu_node_mvc_1.createParameterDecorator((req) => __awaiter(this, void 0, void 0, function* () {
        let tokenText = req.headers['token'];
        if (!tokenText)
            return null;
        let token = yield token_1.Token.parse(tokenText);
    ...
    let appIdDecorator = maishu_node_mvc_1.createParameterDecorator((req) => __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=user-variable.js.map