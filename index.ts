...
import { Settings as GatewaySettings, start as startGateway } from "./gateway";
import { Settings as PermissionSettings, start as startPermission } from "./permission";
...
export function start(settings: Settings) {
    startGateway(settings.gatewaySettings);
