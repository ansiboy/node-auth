...
define(["require", "exports", "maishu-dilu", "../errors", "maishu-ui-toolkit", "assert/services/index"], function (require, exports, maishu_dilu_1, errors_1, maishu_ui_toolkit_1, index_1) {
  "use strict";
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                service = app.createService(index_1.PermissionService);
                username = usernameInput.value;
                password = passwordInput.value;
                _context.next = 7;
                return service.user.login(username, password);
