...
define(["require", "exports", "../errors", "maishu-dilu", "maishu-ui-toolkit", "../services/index"], function (require, exports, errors_1, maishu_dilu_1, maishu_ui_toolkit_1, index_1) {
  "use strict";
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              _context3.next = 7;
              return userService.sms.sendRegisterVerifyCode(mobile);
  ...
  function register(mobile, password, smsId, verifyCode, data, app) {
    var userService = app.createService(index_1.PermissionService);
