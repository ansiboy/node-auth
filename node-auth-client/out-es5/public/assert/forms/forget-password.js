...
define(["require", "exports", "maishu-dilu", "maishu-ui-toolkit", "../errors", "../services/index"], function (require, exports, maishu_dilu_1, maishu_ui_toolkit_1, errors_1, index_1) {
  "use strict";
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                userService = app.createService(index_1.PermissionService);
                _context2.next = 8;
                return userService.user.resetPassword(mobile, password, smsId, verifyCode);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              userService = app.createService(index_1.PermissionService);
              _context3.next = 7;
              return userService.sms.sendResetVerifyCode(mobile);
