...
define(["require", "exports", "maishu-dilu", "maishu-ui-toolkit", "../_errors", "maishu-services-sdk"], function (require, exports, maishu_dilu_1, maishu_ui_toolkit_1, _errors_1, maishu_services_sdk_1) {
  "use strict";
  ...
  function setForm(formElement, app) {
    ...
    if (!resetPasswordButton) throw _errors_1.errors.registerButtonNotExists();
