...
let SMSController = class SMSController {
    sendVerifyCode(dc, { mobile, type }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (type == 'register') {
                ...
                let smsRecords = yield dc.smsRecords.find({ where: { mobile }, select: ["id"] });
            ...
            let obj = {
                id: utility_1.guid(), mobile, content: msg,
                code: verifyCode, create_date_time: new Date(Date.now())
            };
            yield dc.smsRecords.insert(obj);
    ...
    checkVerifyCode(dc, { smsId, verifyCode }) {
        return __awaiter(this, void 0, void 0, function* () {
